...
/*
MAVEN_OPTS='-agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=6005 -Djava.util.logging.config.file=logging.properties -DMY_WEB_APP_PATH=/foo/bar/jersey/examples/helloworld-spring/target/helloworld-spring.war' mvn -Dexec.mainClass=fi.markoa.proto.jersey2.jetty.JettyWebApp clean package exec:java
